    ...
    <main>
      ...
      <article className='max-w-3xl mx-auto p-5'>
        ...
        <div className='flex items-center space-x-2'>
          ...
          <p className='font-extralight text-sm'>
            Blog post by <span className='text-green-800 font-semibold'>{post.author.name}</span>  - Published at{' '}
      ...
      {submitted ? (
        ...
        <form
          ...
          <h3 className='text-sm h-30 text-orange-500'>Enjoyed this article?</h3>
          ...
          <input
            type='submit'
            className='shadow bg-purple-500 hover:bg-yellow-400 focus:shadow-outline focus:outline-none text-white font-bold px-4 py-2 rounded cursor-pointer'
          />
        </form>
      )}
